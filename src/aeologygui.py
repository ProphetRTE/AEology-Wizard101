...
def create_gui(gui_theme, gui_text_color, gui_button_color, tool_name, tool_version, gui_on_top, langcode):
	...
	layout = [
		[gui.Text(tl('AEology will always be a free tool. If you paid for this, you got scammed!'))],
		[gui.TabGroup(tabs)],
		[client_info_layout]
	]
